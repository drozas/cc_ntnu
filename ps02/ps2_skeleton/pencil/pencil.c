...
// External variables - these refer to the state in the generated scanner
...
/*
 * Wrapper function - since we are not implementing next() ourselves
 * this time, the call must be redirected to the generated scanner
 */
command_t
next ( FILE *input )
{
